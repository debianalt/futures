...
Every count in the manuscript's methods section and the supplementary information (including Table S1) is generated by this script from `data/coding.csv` and `data/additional_records.csv`.
